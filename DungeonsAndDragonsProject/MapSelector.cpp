//! @file MapSelector.cpp
//! @brief Concrete implementation of the MapSelector class
//! @author Yousra El Ghomari, 2685587
...
void MapSelector::selectMap()
{
	...
	case 1:
	{
			  ...
			  cout << "Map saved to gameMap.txt" << endl << endl;
			  break;
	}
	case 2:
	{
	...
	case 3:
	{
			  cout << "Enter String name of the file of your saved Map: " << flush;
			  cin >> filename;
...
void MapSelector::standardMap(int Choice){
	...
	cout << "\n 3:" << endl;
	sMap3->printMap();
	cout << "Choose standard Map 1, 2 or 3: " << flush;
	cin >> Choice;
	switch (Choice)
	{
	case 1:
...
void MapSelector::createCustomMap(char cellChoice){
